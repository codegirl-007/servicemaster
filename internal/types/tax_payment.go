...
type TaxPayment struct {
	...
	// PaymentDate is the tax payment date on the wire (JSON key PaymentDate).
	// The attribute table labels this field TxnDate; all documented examples use PaymentDate.
